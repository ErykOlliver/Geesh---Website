    ...
    return (
        <div className='w-[90%] flex flex-col gap-5 items-center justify-center'>
            ...
            <div className='flex flex-col w-full items-center justify-center gap-5 p-1.5'>
                ...
                <a aria-label='aria-label="Download do Geesh.apk"' href="/GeeshWebsite/Geesh.apk" download="Geesh.apk" className=' shadow bg-White-80 text-azure hover:bg-azure hover:shadow-none hover:text-White-80 transition flex gap-1 px-5 py-4 text-xl rounded-full items-center font-Montserrat'> <Download /> Fazer download do Geesh</a>
            </div>
        </div>
    )
}
