    ...
    return (
        <section id="aboutApp" className=" w-full flex flex-col gap-2.5 px-5 bg-White-80 items-start justify-start py-14">
            ...
            <div className=" sm:flex-row flex justify-center items-center w-full h-fit flex-col gap-4 font-Poppins text-graphite-shadow/70">
                ...
                <MemberBase name="Matheus Gabriel" description="Responsável por implementar telas e funcionalidades do aplicativo, seguindo os padrões técnicos definidos pelo Tech Lead." skills="Desenvolvedor de Software" img={"https://pt.dreamstime.com/fotografia-de-stock-travestis-engra%C3%A7ados-que-comem-banana-image28884972"}/>
