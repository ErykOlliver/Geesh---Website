    ...
    return (
        <div className="w-screen flex bg-White-80 items-center justify-center">
            <div className="w-[90%] flex flex-col gap-6 pt-2.5">
                <h1 className="text-2xl text-start font-bold font-Inter uppercase">Equipe de desenvolvimento</h1>
                <div className="w-full flex flex-col items-start gap-5 pt-1.5 pb-2.5">
                ...
                <div className="w-full flex items-start gap-1.5 pt-1.5 pb-2.5">
                    <div className="w-full h-fit flex gap-2.5">
                        <div className="bg-gradient-to-b from-azure to-bluishWhite w-5 rounded-r-2xl"></div>
