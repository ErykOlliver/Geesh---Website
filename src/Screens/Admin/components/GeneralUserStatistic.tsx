...
export const GeneralUserStatistic = (props: StatisticProps) => {
    return (
        <div className="w-44 sm:w-85.5 h-fit shadow bg-phantom-night border-2 border-graphite-shadow rounded-lg items-start p-2.5 gap-2.5 flex flex-col justify-center">
