import { Accessibility, BrainCircuit, CheckCircle, Stars } from "lucide-react";
import BenefitBase from "../components/BenefitBase.tsx";

export default function Advantages() {
    return (
        <section id="aboutApp" className="w-full flex flex-col gap-2.5 bg-White-80 items-start justify-start px-5 py-14">
            <header className="flex w-full text-start flex-col gap-2.5">
                <h1 className="text-4xl font-Poppins text-abyssal-tide font-medium">E quais são as vantagens?</h1>
            </header>
            <div className="sm:flex-row sm:justify-center sm:items-center flex flex-col gap-4 items-start font-Poppins text-graphite-shadow/70">
                ...
                <BenefitBase icon={<Accessibility size={32}/>} title="Acessibilidade Garantida" description="Design intuitivo, simples e inclusivo — qualquer pessoa consegue usar." />
